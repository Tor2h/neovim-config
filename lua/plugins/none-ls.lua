local ensure_none_ls_loaded

ensure_none_ls_loaded = function()
  ...
  ensure_none_ls_loaded = function() end
end

require("lazyload").on_vim_enter(ensure_none_ls_loaded)

vim.keymap.set({ "n", "v" }, "<leader>j", function()
  ensure_none_ls_loaded()

...
local function ensure_global_note_loaded()
  ...
  require('global-note').setup({
    autosave = false,
    directory = "C:\\Users\\th004\\Notes\\",
    filename = "global.md",
    additional_presets = {
      project_private = {
        directory = function()
          return vim.fs.joinpath("C:\\Users\\th004\\Notes\\", get_project_name())
        end,
        filename = "note.md",
...
vim.keymap.set('n', '<leader>m', function()
  ensure_global_note_loaded()
  vim.cmd('ProjectPrivateNote')
end, { desc = "Private Notes", noremap = true, silent = true })

local ensure_gitsigns_loaded

ensure_gitsigns_loaded = function()
  ...
  ensure_gitsigns_loaded = function() end
end

vim.api.nvim_create_autocmd({ "BufReadPost", "BufNewFile" }, {
  group = vim.api.nvim_create_augroup("plugins.gitsigns.lazy", { clear = true }),
  callback = function(args)
    if vim.bo[args.buf].buftype == "" then
      ensure_gitsigns_loaded()
    end
  end,
})
